...
/*1*/
/*SQL-1*/
SELECT cliente.nombre_cliente, CONCAT_WS(' ',empleado.nombre, empleado.apellido1, empleado.apellido2) AS Empleado
...
/*2*/
/*SQL-1*/
SELECT DISTINCT cliente.nombre_cliente,CONCAT_WS(' ',empleado.nombre, empleado.apellido1, empleado.apellido2) AS Empleado
FROM empleado , cliente, pago
WHERE cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado AND pago.codigo_cliente = cliente.codigo_cliente;
/*SQL-2*/
SELECT DISTINCT cliente.nombre_cliente,CONCAT_WS(' ',empleado.nombre, empleado.apellido1, empleado.apellido2) AS Empleado
FROM empleado INNER JOIN cliente
ON cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado
...
/*3*/
/*SQL-1*/
SELECT  DISTINCT empleado.nombre AS Empleado, cliente.nombre_cliente, cliente.codigo_cliente
FROM empleado , cliente
WHERE cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado AND cliente.codigo_cliente NOT IN (SELECT DISTINCT codigo_cliente
									FROM pago);
/*SQL-2*/
SELECT DISTINCT empleado.nombre AS Empleado, cliente.nombre_cliente,cliente.codigo_cliente
FROM empleado INNER JOIN cliente
ON cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado
WHERE cliente.codigo_cliente NOT IN (SELECT DISTINCT codigo_cliente
									FROM pago);

/*4*/
/*SQL-1*/
SELECT  DISTINCT cliente.nombre_cliente,CONCAT_WS(' ',empleado.nombre, empleado.apellido1, empleado.apellido2) AS empleado, oficina.ciudad
FROM empleado , cliente, pago, oficina
WHERE cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado AND pago.codigo_cliente = cliente.codigo_cliente AND empleado.codigo_oficina = oficina.codigo_oficina;
/*SQL-2*/
SELECT  DISTINCT cliente.nombre_cliente,CONCAT_WS(' ',empleado.nombre, empleado.apellido1, empleado.apellido2) AS empleado, oficina.ciudad
FROM empleado INNER JOIN cliente
ON cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado
...
WHERE cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado AND empleado.codigo_oficina = oficina.codigo_oficina AND cliente.codigo_cliente NOT IN (SELECT DISTINCT codigo_cliente
									FROM pago);
/*SQL-2*/                                    
SELECT  DISTINCT cliente.nombre_cliente,CONCAT_WS(' ',empleado.nombre, empleado.apellido1, empleado.apellido2) AS Empleado, oficina.ciudad
FROM empleado INNER JOIN cliente
...
FROM empleado , cliente, oficina
WHERE cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado AND empleado.codigo_oficina = oficina.codigo_oficina AND cliente.linea_direccion2 LIKE '%Fuenlabrada%';
/*SQL-2*/                                    
SELECT oficina.linea_direccion1, oficina.linea_direccion2, cliente.nombre_contacto
FROM empleado INNER JOIN cliente
ON cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado
INNER JOIN oficina
ON empleado.codigo_oficina = oficina.codigo_oficina
...
/*7*/
/*SQL-1*/
SELECT cliente.nombre_cliente,CONCAT_WS(' ',empleado.nombre, empleado.apellido1, empleado.apellido2) AS empleado,oficina.ciudad
FROM empleado , cliente, oficina
...
WHERE   cliente.codigo_cliente = pedido.codigo_cliente
        ...
        AND producto.gama = gama_producto.gama;
/*SQL-2*/
...
FROM pedido
	...
	INNER JOIN
    detalle_pedido ON pedido.codigo_pedido = detalle_pedido.codigo_pedido
	INNER JOIN
    producto ON detalle_pedido.codigo_producto = producto.codigo_producto;
