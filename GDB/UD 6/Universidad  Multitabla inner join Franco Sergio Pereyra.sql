...
FROM persona , alumno_se_matricula_asignatura, asignatura, grado
WHERE persona.id = alumno_se_matricula_asignatura.id_alumno AND alumno_se_matricula_asignatura.id_asignatura = asignatura.id AND asignatura.id_grado = grado.id
AND persona.sexo = 'M' AND persona.tipo = 'alumno' AND grado.nombre = 'Grado en Ingeniería Informática (Plan 2015)';
/*SQL-2*/
SELECT DISTINCT persona.nombre, persona.apellido1, persona.apellido2, grado.nombre
...
WHERE  persona.sexo = 'M' AND persona.tipo = 'alumno' AND grado.nombre = 'Grado en Ingeniería Informática (Plan 2015)';

/*2*/
/*SQL-1*/
SELECT asignatura.*
FROM asignatura, grado
WHERE asignatura.id_grado = grado.id AND grado.nombre = 'Grado en Ingeniería Informática (Plan 2015)';
/*SQL-2*/
...
/*3*/
/*SQL-1*/
SELECT  CONCAT_WS(' ',persona.apellido1, persona.apellido2, persona.nombre) AS profesor, departamento.nombre
FROM persona , profesor, departamento
WHERE persona.id = profesor.id_profesor AND profesor.id_departamento = departamento.id AND persona.tipo = 'profesor'
...
/*4*/
/*SQL-1*/
SELECT asignatura.nombre, curso_escolar.anyo_inicio, curso_escolar.anyo_fin, persona.*
FROM persona , alumno_se_matricula_asignatura, asignatura, curso_escolar
WHERE persona.id = alumno_se_matricula_asignatura.id_alumno AND alumno_se_matricula_asignatura.id_asignatura = asignatura.id AND alumno_se_matricula_asignatura.id_curso_escolar = curso_escolar.id
AND persona.tipo = 'alumno' AND persona.nif LIKE '26902806M';
/*SQL-2*/
SELECT asignatura.nombre, curso_escolar.anyo_inicio, curso_escolar.anyo_fin, persona.*
FROM persona INNER JOIN alumno_se_matricula_asignatura
ON persona.id = alumno_se_matricula_asignatura.id_alumno 
...
WHERE persona.tipo = 'alumno' AND persona.nif LIKE '26902806M';

/*5*/
/*SQL-1*/
SELECT DISTINCT CONCAT_WS(' ',persona.apellido1, persona.apellido2, persona.nombre) AS profesor, departamento.nombre
FROM persona , profesor, departamento , asignatura, grado
WHERE persona.id = profesor.id_profesor AND profesor.id_departamento = departamento.id AND profesor.id_profesor = asignatura.id_profesor AND asignatura.id_grado = grado.id 
AND persona.tipo = 'profesor' AND grado.nombre = 'Grado en Ingeniería Informática (Plan 2015)';
/*SQL-2*/
SELECT DISTINCT CONCAT_WS(' ',persona.apellido1, persona.apellido2, persona.nombre) AS profesor, departamento.nombre
FROM persona INNER JOIN profesor
ON persona.id = profesor.id_profesor
...
INNER JOIN grado
ON asignatura.id_grado = grado.id
WHERE   persona.tipo = 'profesor' AND grado.nombre = 'Grado en Ingeniería Informática (Plan 2015)';

/*6*/
/*SQL-1*/
SELECT  DISTINCT CONCAT_WS(' ',persona.apellido1, persona.apellido2, persona.nombre) AS Alumno
FROM persona , alumno_se_matricula_asignatura, asignatura, curso_escolar
WHERE persona.id = alumno_se_matricula_asignatura.id_alumno AND alumno_se_matricula_asignatura.id_asignatura = asignatura.id AND alumno_se_matricula_asignatura.id_curso_escolar = curso_escolar.id
AND persona.tipo = 'alumno' AND curso_escolar.anyo_inicio LIKE '2018' AND curso_escolar.anyo_fin LIKE '2019' ;
/*SQL-2*/
SELECT  DISTINCT CONCAT_WS(' ',persona.apellido1, persona.apellido2, persona.nombre) AS Alumno
FROM persona INNER JOIN alumno_se_matricula_asignatura
ON persona.id = alumno_se_matricula_asignatura.id_alumno 
...
INNER JOIN curso_escolar
ON alumno_se_matricula_asignatura.id_curso_escolar = curso_escolar.id
WHERE persona.tipo = 'alumno' AND curso_escolar.anyo_inicio LIKE '2018' AND curso_escolar.anyo_fin LIKE '2019' ;
