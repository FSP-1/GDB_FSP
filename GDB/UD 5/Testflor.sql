...
SELECT CONCAT_WS( ' ',nombre, apellido1 ) AS ALUMNO
FROM alumno;
SELECT UPPER(CONCAT_WS( ' ',nombre, apellido2,apellido1 )) AS ALUMNO
FROM alumno;
SELECT CONCAT_WS('',lower(SUBSTR(nombre,1,1)),lower(SUBSTR(apellido1,1,3)),lower(SUBSTR(apellido2,1,3)),'@francoweb.com') AS ALUMNO
FROM alumno;
...
SELECT CONCAT_WS( ' ',nombre, apellido1,apellido2 ) AS ALUMNO, CONCAT_WS('',SUBSTR(nombre,1,1),SUBSTR(apellido1,1,3),'@francoweb.com') AS ALUMNO
FROM alumno;